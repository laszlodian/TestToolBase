    ...
    public class Operation : ISqlSaveable, ISqlLoadable
    {
        ...
        public void SqlSave(Npgsql.NpgsqlCommand insertCommand_in)
        {
            if(OperationDescription == null || OperationDescription == string.Empty)
                throw new TestToolsBaseException("OperationDescription has not been set.");
        ...
        public void SqlLoad(NpgsqlDataReader sqlData_in)
        {
            ...
            if (TestToolsBase.Modell.MeasureCollectionBase.TheMeasures != null
                && TestToolsBase.Modell.SqlHiLevel.Load_nContinue)
            {
                TestToolsBase.Modell.MeasureCollectionBase.TheMeasures.MeasureDate = Date;
            }
