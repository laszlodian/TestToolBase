...
namespace TestToolsBase.Modell
{
    public abstract class MeasureCollectionBase : MeasureRoot, ISqlMainTable
    {
        ...
        /// </summary>
        public TestToolsBaseClass TheMeasure
        {
            get
            {
                if (this.Measures == null || this.Measures.Count != 1)
                    throw new InvalidOperationException("get_TheMeasure is valid only if there are exactly one measure.\nIn case of Sql loading if the Measure itself is not SqlLoadable you should create TheMeasure at overriden function of TestToolsBase.SqlLoad(). E.g.: 'this.Measures.Add(new MeasureMeo());'");
        ...
        List<TestToolsBaseClass> _Measures = new List<TestToolsBaseClass>();

        public List<TestToolsBaseClass> Measures
        {
        ...
        /// </summary>
        /// <returns></returns>
        protected internal virtual TestToolsBaseClass CreateMeasure()
        {
        ...
        public override void CheckSqlConsistency()
        {
            ...
            foreach (TestToolsBaseClass measure in Measures)
