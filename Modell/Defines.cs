...
namespace TestToolsBase.Modell
{
    ...
    {
        /// <summary>
        /// CollectionKey for TestToolsBaseClass
        /// </summary>
    ...
    {
        TestToolsBaseClass MyMeasure { get; set; }
    }
    ...
    public class WrongSqlRecordNumberException : TestToolsBaseException
    {
    ...
    public class WrongCheckNumberException : TestToolsBaseException
    {
