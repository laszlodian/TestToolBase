...
namespace TestToolsBase.Modell
{
    ...
    public class SqlRowDescriptorHierarchy : SqlRowDescriptor
    {
        ...
        public long ParentId
        {
            get
            {
                if (TableDescriptor is TestToolsBase.Modell.SqlTableDescriptorHierarhyTableBase == false)
                {
        ...
        public Dictionary<string, object> SqlLoadedResults
        {
            ...
            set
            {
                if (false == this.TableDescriptor is TestToolsBase.Modell.SqlTableDescriptorHierarhyTableBase
                    || ((TestToolsBase.Modell.SqlTableDescriptorHierarhyTableBase)this.TableDescriptor).ConsistencyFullCollection)
                    throw new TestToolsBaseInternalException(string.Format("SqlLoadedResults can be used only for 'OnlyResult == false'. Problem with table: {0}",
