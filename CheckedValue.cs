        ...
        public string ResultStr
        {
            get
            {
                switch (_Result)
                {
                    ...
                    default:
                        throw new TestToolsBaseInternalException(string.Format("Invalid _Result: '{0}'. this. Perhaps, this.Check has not been called.", _Result));
                }
            }
        }
