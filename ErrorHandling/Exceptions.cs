...
{
  /// <summary>
  /// Base class for all exception (TestToolsBase and applications)
  /// </summary>
  ...
  public class E77Exception : Exception
  {
    ...
    /// </summary>
    public class TestToolsBaseException : E77Exception
    {
        public TestToolsBaseException() { ; }

        public TestToolsBaseException(string message) :
            base(message)
        { ;}

        public TestToolsBaseException(string format_in, params object[] params_in) :
            base(string.Format(format_in, params_in))
        { ;}

        public TestToolsBaseException(string message, Exception innerException) :
            base(message, innerException)
        { ;}
    }
    ...
    /// </summary>
    public class TestToolsBaseInternalException : TestToolsBaseException
    {
        public TestToolsBaseInternalException(string message) :
            base(message)      { ; }

        public TestToolsBaseInternalException(string format_in, params object[] params_in) :
            base(string.Format(format_in, params_in))
        { ; }

        public TestToolsBaseInternalException(string message, Exception innerException) :
            base(message, innerException)   { ; }
    }
    ...
    public class NotFoundException : TestToolsBaseException
    {
    ...
    public class SqlStructureInconsistencyException : TestToolsBaseException
    {
    ...
    public class SqlNoValueException : TestToolsBaseException
    {
    ...
    public class SqlNotFoundException : TestToolsBaseException
    {
