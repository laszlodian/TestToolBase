...
namespace TestToolsBase.MeasureEnvironment
{
    public class e77User
    {
        ...
        {
            if(TheUser != null)
                throw new TestToolsBaseException("Singleton");
            TheUser = this;
        ...
        static public string GetFullName(string userName_in)
        {
            ...
            try
            {
                ...
                //    throw new TestToolsBaseInternalException(string.Format("More user with id {0} at LDAP", userName_in));
            ...
            {
                ex.ReportError();
                throw new Exception(string.Format(Resources.ACCOUNT_MANAGEMENT_ERROR, userName_in), ex);
            }
        ...
        {
            get { return EnvironmentId.TheEnvironmentId.ALL_ACCESS_RIGHTS; } 
        }

        private bool IsAccessRightValid(string accessRight_in)
        {
            if (ALL_ACCESS_RIGHTS == null)
                throw new TestToolsBaseException("User.ALL_ACCESS_RIGHTS has not been initialized.");
