...
namespace TestToolsBase
{
    public class ResultModell
    {
        ...
        public ResultModell(string lot, string roll, string sn, string user, string comp, string error, string error_text,
        ...
        public ResultModell(string lot_id, string roll_id, string res, string homogenity_avg, string avg_ok, string homogenity_cv, string cv_ok,
        ...
        public string After_H_OutOfRange
        {
            get
            {
                return ResultModell.OutOfRangeCount_Homo.ToString();
            }

            set
            {
                after_homo_outofrange = ResultModell.OutOfRangeCount_Homo.ToString();
            }
        ...
        public ResultModell(string lot, string roll, string meas, double glu, double nano, int sn, string barcode, bool remeas)
        {
        ...
        public ResultModell(string lot, string roll, double averages, double ceve, DateTime test_date, int tube_count, bool blank_is_valid, string res)
        {
            lotid = lot;
            rollid = roll;
        ...
        /// <param name="ceve"></param>
        /// <param name="test_date"></param>
        public ResultModell(string lot, string roll, string res, string averages, string ceve, string test_date)
        {
            try
            {
        ...
        /// <param name="ceve"></param>
        /// <param name="test_date"></param>
        public ResultModell(string lot, string roll, string res, string averages, bool avg_ok, double blank_cv, string measure, DateTime dt)
        {
            try
            {
        ...
        public ResultModell(string lot, string roll, string res, string averages, string ceve,
        ...
        private static object OutOfRangeCount_Homo;
